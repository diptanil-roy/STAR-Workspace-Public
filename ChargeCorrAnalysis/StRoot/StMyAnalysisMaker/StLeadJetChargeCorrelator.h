#ifndef StLeadJetChargeCorrelator_h
#define StLeadJetChargeCorrelator_h

#include "StJetFrameworkPicoBase.h"
#include "StChargeCorrelatorStruct.h"
...
class StLeadJetChargeCorrelator : public StJetFrameworkPicoBase {
  public:

    StLeadJetChargeCorrelator(const char *name, StPicoDstMaker *picoMaker, const char *outName, const char *jetMakerName, const char *rhoMakerName);
    virtual ~StLeadJetChargeCorrelator();
  ...
  private:
    ...
    StChargeCorrelatorStruct mChargeCorrStruct;
    ...
    ClassDef(StLeadJetChargeCorrelator, 1)
};
#endif
