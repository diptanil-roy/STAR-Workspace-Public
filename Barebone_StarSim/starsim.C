...
void starsim( Int_t nevents=10, double ckin3 = 0.0, double ckin4 = 3.0 )
{ 
...
//   }
  ...
  Pythia8("pp:minbias", ckin3, ckin4 ); // This is the main function call. This sets up the PYTHIA generator to do your bidding.
  ...
  // This area is where you set up your own filters. If you need specific filters, you need to write them yourself.
  ...
  while (true) {
    ...
    trig( gRandom->Uniform(-6,6) ); // Generating a random vertex z between +- 6 cm
