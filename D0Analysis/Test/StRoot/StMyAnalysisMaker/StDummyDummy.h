#ifndef StDummyDummy_h
#define StDummyDummy_h
...
class StDummyDummy : public StJetFrameworkPicoBase {
  public:

    StDummyDummy(const char *name, StPicoDstMaker *picoMaker, const char* vertexfilename, const char *outName, const char *jetMakerName, const char *rhoMakerName);
    virtual ~StDummyDummy();
