...
class StMCJetTreeMaker : public StJetFrameworkPicoBase {
  public:

    StMCJetTreeMaker(const char *name, StPicoDstMaker *picoMaker, const char *outName, const char *jetMakerName, const char *rhoMakerName);
