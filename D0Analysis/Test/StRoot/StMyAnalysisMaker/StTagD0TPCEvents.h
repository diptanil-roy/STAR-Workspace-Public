#ifndef StTagD0TPCEvents_h
#define StTagD0TPCEvents_h
...
class StTagD0TPCEvents : public StJetFrameworkPicoBase {
  public:

    bool testrun = kTRUE;

    StTagD0TPCEvents(const char* name, StPicoDstMaker *picoMaker, const char* outName);
    virtual ~StTagD0TPCEvents();
  ...
  private:
    ...
    THnF *hD0CentPtEtaMDphiDaugLikeSign;
