...
class StJetTreeMaker : public StJetFrameworkPicoBase {
  public:

    StJetTreeMaker(const char *name, StPicoDstMaker *picoMaker, const char *outName, const char *jetMakerName, const char *rhoMakerName);
