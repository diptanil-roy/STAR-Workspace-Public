...
//#include "StarGenerator/Pythia8_2_35/StarPythia8.h"  // STAR Pythia8 wrapper
...
ClassImp(StDummyPythiaMaker)

//________________________________________________________________________
StDummyPythiaMaker::StDummyPythiaMaker(const char* name, StPicoDstMaker *picoMaker, const char* outName = "", const char* jetMakerName = "", const char* rhoMakerName = "") : StJetFrameworkPicoBase(name) //StMaker(name),
{
  ...
  fDebugLevel = 0;
  fRunFlag = 0;       // see StDummyPythiaMaker::fRunFlagEnum
  doppAnalysis = kFALSE;
...
//
//________________________________________________________________________
StDummyPythiaMaker::~StDummyPythiaMaker()
{ /*  */
  // destructor
...
//________________________________________________________________________
Int_t StDummyPythiaMaker::Finish() { 
  cout << "StDummyPythiaMaker::Finish()\n";
  ...
  cout<<"End of StDummyPythiaMaker::Finish"<<endl;
...
//________________________________________________________________________
void StDummyPythiaMaker::DeclareHistograms() {
...
void StDummyPythiaMaker::WriteHistograms() {
...
//_____________________________________________________________________________
void StDummyPythiaMaker::Clear(Option_t *opt) {
  fJets->Clear();
}
//
//  Function: This method is called every event.
//_____________________________________________________________________________
Int_t StDummyPythiaMaker::Make() {
...
void StDummyPythiaMaker::RunJets()
{
...
//
//________________________________________________________________________
void StDummyPythiaMaker::RunTracks()
{
...
//
//________________________________________________________________________
void StDummyPythiaMaker::RunTowers()
{
  // constants: assume neutral pion mass
  double pi = 1.0*TMath::Pi();
  double pi0mass = Pico::mMass[0]; // GeV
...
void StDummyPythiaMaker::SetSumw2() {
  hCentrality->Sumw2();
  hMultiplicity->Sumw2();
  hJetPt->Sumw2();
  hJetCorrPt->Sumw2();
...
//________________________________________________________________________
Double_t StDummyPythiaMaker::RelativePhi(Double_t mphi,Double_t vphi) const
...
Double_t StDummyPythiaMaker::RelativeEPJET(Double_t jetAng, Double_t EPAng) const
{
...
//
//_________________________________________________________________________
void StDummyPythiaMaker::FillEmcTriggers() {
...
//________________________________________________________________________
Bool_t StDummyPythiaMaker::DoComparison(int myarr[], int elems) {
