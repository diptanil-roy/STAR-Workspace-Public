...
void ppQA(const Char_t *inputFile="Run14_P18ih_HPSS_15164046.list", const Char_t *outputFile="test.root", Int_t nEv = 1000, const Char_t *fOutJobappend=""){
  ...
  //StPicoDstMaker *picoMaker = new StPicoDstMaker(0,inputFile,"picoDst");
    ...
    StPIDQA *PidQA = new StPIDQA("PIDQA", picoMaker, outputFile);
