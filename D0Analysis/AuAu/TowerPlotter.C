...
void TowerPlotter(const Char_t *inputFile="Run14_P18ih_HPSS_15164046.list", const Char_t *outputFile="test.root", Int_t nEv = 10, const Char_t *fOutJobappend=""){
  ...
  // create the analysis maker!
    ...
    StTowerMapper *TowerMapper = new StTowerMapper("TowerMapper", picoMaker, outputFile, "", "");
    cout << TowerMapper->GetName() << endl;
