#ifndef StTagKStarEvents_h
#define StTagKStarEvents_h
...
class StTagKStarEvents : public StJetFrameworkPicoBase {
  public:

    bool testrun = kTRUE;

    StTagKStarEvents(const char* name, StPicoDstMaker *picoMaker, const char* outName);
    virtual ~StTagKStarEvents();
    ...
    void      FillTopoHistograms(int centbin, int d0bin, int pid1pid2, double d0pt, double mDecayLength, double mDcaDaughters, double perpDcaToVtx, double mKaonDca, double mPionDca, double costheta);
