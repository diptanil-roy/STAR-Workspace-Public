...
//class StPicoTrackClusterQA : public StJetFrameworkPicoBase {
 ...
 private:
  ...
  TH1F           *fHistHFTNTrackvsPt;//!
  TH1F           *fHistHFTNTrackvsPhi;//!
  TH1F           *fHistHFTNTrackvsEta;//!
  TH2F           *fHistHFTNTrackvsPhivsEta;//!
  ...
  // Track Tower Matched Plots
  TH2F *PicoVsProjectedTowerID;
  TH2F *PtVsPicoVsProjectedTowerID[6];
