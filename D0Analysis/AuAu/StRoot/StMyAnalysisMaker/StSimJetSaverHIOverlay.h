#ifndef StSimJetSaverHIOverlay_h
#define StSimJetSaverHIOverlay_h
...
class StSimJetSaverHIOverlay : public StJetFrameworkPicoBase {
  public:

    StSimJetSaverHIOverlay(const char *name, StPicoDstMaker *picoMaker, const char *outName, const char *mcjetMakerName, const char* recojetMakerName, const char *d0taggername, const char *rhoMakerName);
    virtual ~StSimJetSaverHIOverlay();
    ...
    virtual void            SetSmearFactorForJetPt (double smear) {fSmearFactor = smear;} //This factor comes from background fluctuation study!
  ...
  private:
    ...
    std::vector<std::vector<double> > eventdatapicodst;
    ...
    StSimD0EventsHIOverlayJetMaker  *recoJetMaker;
    StSimD0RhoHIOverlay    *mD0RhoHIOverlay;
    ...
    ClassDef(StSimJetSaverHIOverlay, 1)
};
#endif
