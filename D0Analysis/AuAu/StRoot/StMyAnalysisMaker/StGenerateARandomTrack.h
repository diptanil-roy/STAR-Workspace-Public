#ifndef StGenerateARandomTrack_h
#define StGenerateARandomTrack_h
...
class StGenerateARandomTrack : public StJetFrameworkPicoBase {
  public:

    bool testrun = kTRUE;

    StGenerateARandomTrack(const char* name, StPicoDstMaker *picoMaker, const char* outName);
    virtual ~StGenerateARandomTrack();
  ...
  private:
    ...
    ClassDef(StGenerateARandomTrack, 1)
};
#endif
