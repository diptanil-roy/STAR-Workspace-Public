#ifndef StReadTwoPicoDsts_h
#define StReadTwoPicoDsts_h
...
class StReadTwoPicoDsts : public StJetFrameworkPicoBase {
  public:

    StReadTwoPicoDsts(const char *name, StPicoDstReader *Reader1, StPicoDstReader *Reader2, const char* vertexfilename, const char *outName, const char *jetMakerName, const char *rhoMakerName);
    virtual ~StReadTwoPicoDsts();
  ...
  private:
    ...
    StPicoDstMaker *mPicoDstMakerMC;

    StPicoDstReader *mPicoDstReader;
    StPicoDstReader *mPicoDstReaderMC;

    StPicoDst *mPicoDstMC;
    StPicoEvent *mPicoEventMC;

    std::ofstream vertexfile;

    ClassDef(StReadTwoPicoDsts, 1)
};
#endif
