#ifndef StTowerMapper_h
#define StTowerMapper_h
...
class StTowerMapper : public StJetFrameworkPicoBase {
  public:

    StTowerMapper(const char *name, StPicoDstMaker *picoMaker, const char *outName, const char *jetMakerName, const char *rhoMakerName);
    virtual ~StTowerMapper();
