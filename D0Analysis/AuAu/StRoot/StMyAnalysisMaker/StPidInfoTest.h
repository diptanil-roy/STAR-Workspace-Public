#ifndef StPidInfoTest_h
#define StPidInfoTest_h
...
class StPidInfoTest : public StJetFrameworkPicoBase {
  public:

    StPidInfoTest(const char *name, StPicoDstMaker *picoMaker, const char *outName, const char* jetMakerName, const char *rhoMakerName);
    virtual ~StPidInfoTest();
