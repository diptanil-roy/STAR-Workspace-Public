#ifndef StTagDStarEvents_h
#define StTagDStarEvents_h
...
class StTagDStarEvents : public StJetFrameworkPicoBase {
  public:

    bool testrun = kTRUE;

    StTagDStarEvents(const char* name, StPicoDstMaker *picoMaker, const char* outName);
    virtual ~StTagDStarEvents();
  ...
  protected:
    ...
    std::vector<std::vector<double> >  fd0TrackIndices; //Index of Pion Kaon D0Mass
  ...
  private:
    ...
    TH1F *invmassdiff;
    TH1F *invmassdiffside;
    TH1F *invmassdiffwrong;

    TH2F *invmassdiffDStarvpt;
    TH2F *invmassdiffsideDStarvpt;
