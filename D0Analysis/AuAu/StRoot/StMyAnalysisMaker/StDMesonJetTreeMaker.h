#ifndef StDMesonJetTreeMaker_h
#define StDMesonJetTreeMaker_h

#include "StJetFrameworkPicoBase.h"
#include "StDStarJetTreeStruct.h"
#include <vector>
...
class StDMesonEventsJetMaker;
class StD0Rho;

class StDMesonJetTreeMaker : public StJetFrameworkPicoBase {
  public:

    StDMesonJetTreeMaker(const char *name, StPicoDstMaker *picoMaker, const char *outName, const char *jetMakerName, const char *rhoMakerName);
    virtual ~StDMesonJetTreeMaker();
    ...
    void                    SetD0Analysis(bool d0)               { fAnalysisKind = d0; }
  ...
  protected:
    ...
    Bool_t                  fAnalysisKind;
    Double_t                fD0Kind;                 // D0s, Bg D0s US, LS
    Double_t                fDStarKind;                 // D0s, Bg D0s US, LS
  ...
  private:
    ...
    StDMesonEventsJetMaker *D0JetMaker;//!
    StD0Rho *D0RhoMaker;
    ...
    ClassDef(StDMesonJetTreeMaker, 1)
};
#endif
