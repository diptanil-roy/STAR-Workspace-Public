...
void AuAu200GeVP16idQA(const Char_t *inputFile="Run14_P18ih_HPSS_15164046.list", const Char_t *outputFile="test.root", Int_t nEv = 10, const Char_t *fOutJobappend=""){
  ...
  // create the analysis maker!
    ...
    D0Tagger_Tight->SetSignalRange(1.7, 2.1);
    D0Tagger_Tight->SetBackgroundRangeLS(1.7, 2.1);
    D0Tagger_Tight->SetPtCutOffForD0Daughters(0.2);
    // D0Tagger_Tight->DoNotFillDaugHistograms();
