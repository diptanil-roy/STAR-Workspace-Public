...
void Tester(const Char_t *inputFile="Run14_P18ih_HPSS_15164046.list", const Char_t *outputFile="TestWithCS.root", Int_t nEv = 10, const Char_t *fOutJobappend=""){
  ...
  //StPicoDstMaker *picoMaker = new StPicoDstMaker(0,inputFile,"picoDst");
    ...
    rhoTask = new StD0Rho(Form("D0Rho"), dohisto, outputFile, Form("D0JetMakerBG"));
