...
const int nBinsJetPtForZHist = 9;
...
double JetPtBinsForZHist[nBinsJetPtForZHist + 1] = {0, 1, 3, 5, 7, 9, 11, 13, 15, 20};
...
TH1D *SetName(TH1D *h, TString Name){
  h->SetNameTitle(Name.Data(), Name.Data());
  return h;
}

TH1D *SetColor(TH1D *h, int color, int marker = 20){
