...
void Method(TString DirName = "MCMCUnf", int D0pTLow = 1, int SUPERITERATION = 1, int iteration = 4, bool simpleunfolding = kFALSE){
	...
	TFile *DataFile = new TFile(Form("../SPlotUpdated/CS_JetpT_0_50/Histograms3_D0%i_10GeV_RecoJetPt_%i_%i_NewBinningOldCuts.root", D0pTLow, 0, (int)nbinsjetpt[njpt_bins] ), "READ");
	DataFile->cd();
