...
bool useLowD0Pt = true;// for D0 1-3 GeV //changing it to D0 1-10 GeV now 
...
char NAME[100] = "Histograms3_D01_10GeV_NewBinningOldCuts.root";
int SAVE = 1;
...
double fillHistos(char file[100], TH1F* D0Pt,TH1F* JetPt, TH1F* Z, TH1F* R, TH2F* ZPt,int cen_low,int cen_high, TH1F* hArea, TH1F* JetEta, TH1F* D0Eta, TH1F* JetPhi, TH1F* D0Phi, TH2F* D0JetEta, TH1F *Eta, TH2F*JetPt_R){
	...
	if(useLowD0Pt && (mPt < 1))continue;
	if(usePt && (mJPt<3))continue;
        // if (mJPt > 3 && mJPt < 5) cout << mJPt << "\t" << mPt << endl;
	...
	if(useEff && useDouble) weight *= (1.-dcount) / eff ;
        ...
        if (mCen >= 40 && mCen < 60 && mPt < 5 && mJPt >= 15 && mJPt < 18) cout << "Before = " << mCen << "\t" << mJPt << "\t" << mPt << "\t" << weight << endl;
        sumw+=weight;
...
void applyWeightsNewBinningOldCuts(int save = SAVE){
    ...
    TH1F *JetPt_1 = new TH1F("JetPt_1","JetPt_1",njpt_bins,jetpt_low, jetpt_high);
    ...
    TH2F *ZPt_1 = new TH2F("ZPt_1","ZPt_1",njpt_bins,jetpt_low, jetpt_high,nz_bins,z_low, z_high);
  ...
  TH1F *JetPt_5 = new TH1F("JetPt_5","JetPt_5",njpt_bins,jetpt_low, jetpt_high);
  ...
  TH2F *ZPt_5 = new TH2F("ZPt_5","ZPt_5",njpt_bins,jetpt_low, jetpt_high,nz_bins,z_low, z_high);
  TH2F *Hard2D2_5 = new TH2F("r_Hard2D2_5","r_Hard2D2_5",100,0,50,100,0,5);
  TH1F *D0Pt_6 = new TH1F("D0Pt_6","D0Pt_6",PTBINS,edges);//50,0,50);                                                                                                                                                          
  TH1F *JetPt_6 = new TH1F("JetPt_6","JetPt_6",njpt_bins,jetpt_low, jetpt_high);
  ...
  TH2F *ZPt_6 = new TH2F("ZPt_6","ZPt_6",njpt_bins,jetpt_low, jetpt_high,nz_bins,z_low, z_high);

  TH1F *D0Pt_7 = new TH1F("D0Pt_7","D0Pt_7",PTBINS,edges);//50,0,50);                                                                                                                                                          
  TH1F *JetPt_7 = new TH1F("JetPt_7","JetPt_7",njpt_bins,jetpt_low, jetpt_high);
  TH1F *Z_7 = new TH1F("Z_7","Z_7",nbins_z,binning_z);
  TH1F *R_7 = new TH1F("R_7","R_7",nBinsdR,dRBins);
  TH2F *ZPt_7 = new TH2F("ZPt_7","ZPt_7",njpt_bins,jetpt_low, jetpt_high,nz_bins,z_low, z_high);  
  ...
  // sumw+=fillHistos1("../sPlot/NewsWeight_PT_1_3_Cen_0_80.root",PT2D,D0Pt,JetPt,Z,R,ZPt,0,80,centrality,hArea,JetEta,D0Eta,JetPhi,D0Phi,D0JetEta,Eta,JetPt_R);
  // sumw+=fillHistos1("../sPlot/NewsWeight_PT_3_10_Cen_0_80.root",PT2D,D0Pt,JetPt,Z,R,ZPt,0,80,centrality,hArea,JetEta,D0Eta,JetPhi,D0Phi,D0JetEta,Eta,JetPt_R);
  sumw+=fillHistos1("../sPlot/NewsWeight_PT_1_10_Cen_0_80.root",PT2D,D0Pt,JetPt,Z,R,ZPt,0,80,centrality,hArea,JetEta,D0Eta,JetPhi,D0Phi,D0JetEta,Eta,JetPt_R);

  // sumw1+=fillHistos("../sPlot/NewsWeight_PT_1_3_Cen_0_10.root",D0Pt_1,JetPt_1,Z_1,R_1,ZPt_1,0,10,hArea_1,JetEta_1,D0Eta_1,JetPhi_1,D0Phi_1,D0JetEta_1,Eta_1,JetPt_R_1);
  // sumw1+=fillHistos("../sPlot/NewsWeight_PT_3_10_Cen_0_10.root",D0Pt_1,JetPt_1,Z_1,R_1,ZPt_1,0,10,hArea_1,JetEta_1,D0Eta_1,JetPhi_1,D0Phi_1,D0JetEta_1,Eta_1,JetPt_R_1);
  sumw1+=fillHistos("../sPlot/NewsWeight_PT_1_10_Cen_0_10.root",D0Pt_1,JetPt_1,Z_1,R_1,ZPt_1,0,10,hArea_1,JetEta_1,D0Eta_1,JetPhi_1,D0Phi_1,D0JetEta_1,Eta_1,JetPt_R_1);

  // sumw2+=fillHistos("../sPlot/NewsWeight_PT_1_3_Cen_10_20.root",D0Pt_2,JetPt_2,Z_2,R_2,ZPt_2,10,20,hArea_2,JetEta_2,D0Eta_2,JetPhi_2,D0Phi_2,D0JetEta_2,Eta_2,JetPt_R_2);
  // sumw2+=fillHistos("../sPlot/NewsWeight_PT_3_10_Cen_10_20.root",D0Pt_2,JetPt_2,Z_2,R_2,ZPt_2,10,20,hArea_2,JetEta_2,D0Eta_2,JetPhi_2,D0Phi_2,D0JetEta_2,Eta_2,JetPt_R_2);
  sumw2+=fillHistos("../sPlot/NewsWeight_PT_1_10_Cen_10_20.root",D0Pt_2,JetPt_2,Z_2,R_2,ZPt_2,10,20,hArea_2,JetEta_2,D0Eta_2,JetPhi_2,D0Phi_2,D0JetEta_2,Eta_2,JetPt_R_2);

  // sumw3+=fillHistos("../sPlot/NewsWeight_PT_1_3_Cen_20_30.root",D0Pt_3,JetPt_3,Z_3,R_3,ZPt_3,20,30,hArea_3,JetEta_3,D0Eta_3,JetPhi_3,D0Phi_3,D0JetEta_3,Eta_3,JetPt_R_3);
  // sumw3+=fillHistos("../sPlot/NewsWeight_PT_3_10_Cen_20_30.root",D0Pt_3,JetPt_3,Z_3,R_3,ZPt_3,20,30,hArea_3,JetEta_3,D0Eta_3,JetPhi_3,D0Phi_3,D0JetEta_3,Eta_3,JetPt_R_3);
  sumw3+=fillHistos("../sPlot/NewsWeight_PT_1_10_Cen_20_30.root",D0Pt_3,JetPt_3,Z_3,R_3,ZPt_3,20,30,hArea_3,JetEta_3,D0Eta_3,JetPhi_3,D0Phi_3,D0JetEta_3,Eta_3,JetPt_R_3);

  // sumw4+=fillHistos("../sPlot/NewsWeight_PT_1_3_Cen_30_40.root",D0Pt_4,JetPt_4,Z_4,R_4,ZPt_4,30,40,hArea_4,JetEta_4,D0Eta_4,JetPhi_4,D0Phi_4,D0JetEta_4,Eta_4,JetPt_R_4);
  // sumw4+=fillHistos("../sPlot/NewsWeight_PT_3_10_Cen_30_40.root",D0Pt_4,JetPt_4,Z_4,R_4,ZPt_4,30,40,hArea_4,JetEta_4,D0Eta_4,JetPhi_4,D0Phi_4,D0JetEta_4,Eta_4,JetPt_R_4);
  sumw4+=fillHistos("../sPlot/NewsWeight_PT_1_10_Cen_30_40.root",D0Pt_4,JetPt_4,Z_4,R_4,ZPt_4,30,40,hArea_4,JetEta_4,D0Eta_4,JetPhi_4,D0Phi_4,D0JetEta_4,Eta_4,JetPt_R_4);

  // sumw5+=fillHistos2("../sPlot/NewsWeight_PT_1_3_Cen_40_80.root",D0Pt_5,JetPt_5,Z_5,R_5,ZPt_5,D0JPt_5,Hard2D2_5,40,80,hArea_5,JetEta_5,D0Eta_5,JetPhi_5,D0Phi_5,D0JetEta_5,Eta_5,JetPt_R_5);
  // sumw5+=fillHistos2("../sPlot/NewsWeight_PT_3_10_Cen_40_80.root",D0Pt_5,JetPt_5,Z_5,R_5,ZPt_5,D0JPt_5,Hard2D2_5,40,80,hArea_5,JetEta_5,D0Eta_5,JetPhi_5,D0Phi_5,D0JetEta_5,Eta_5,JetPt_R_5);
  sumw5+=fillHistos2("../sPlot/NewsWeight_PT_1_10_Cen_40_80.root",D0Pt_5,JetPt_5,Z_5,R_5,ZPt_5,D0JPt_5,Hard2D2_5,40,80,hArea_5,JetEta_5,D0Eta_5,JetPhi_5,D0Phi_5,D0JetEta_5,Eta_5,JetPt_R_5);


  // sumw6+=fillHistos("../sPlot/NewsWeight_PT_1_3_Cen_10_20.root",D0Pt_6,JetPt_6,Z_6,R_6,ZPt_6,10,40,hArea_6,JetEta_6,D0Eta_6,JetPhi_6,D0Phi_6,D0JetEta_6,Eta_6,JetPt_R_6);
  // sumw6+=fillHistos("../sPlot/NewsWeight_PT_3_10_Cen_10_20.root",D0Pt_6,JetPt_6,Z_6,R_6,ZPt_6,10,40,hArea_6,JetEta_6,D0Eta_6,JetPhi_6,D0Phi_6,D0JetEta_6,Eta_6,JetPt_R_6);
  sumw6+=fillHistos("../sPlot/NewsWeight_PT_1_10_Cen_10_20.root",D0Pt_6,JetPt_6,Z_6,R_6,ZPt_6,10,40,hArea_6,JetEta_6,D0Eta_6,JetPhi_6,D0Phi_6,D0JetEta_6,Eta_6,JetPt_R_6);
  sumw6+=fillHistos("../sPlot/NewsWeight_PT_1_10_Cen_20_30.root",D0Pt_6,JetPt_6,Z_6,R_6,ZPt_6,10,40,hArea_6,JetEta_6,D0Eta_6,JetPhi_6,D0Phi_6,D0JetEta_6,Eta_6,JetPt_R_6);
  sumw6+=fillHistos("../sPlot/NewsWeight_PT_1_10_Cen_30_40.root",D0Pt_6,JetPt_6,Z_6,R_6,ZPt_6,10,40,hArea_6,JetEta_6,D0Eta_6,JetPhi_6,D0Phi_6,D0JetEta_6,Eta_6,JetPt_R_6);

  // sumw6+=fillHistos("../sPlot/NewsWeight_PT_1_10_Cen_10_40.root",D0Pt_6,JetPt_6,Z_6,R_6,ZPt_6,10,40,hArea_6,JetEta_6,D0Eta_6,JetPhi_6,D0Phi_6,D0JetEta_6,Eta_6,JetPt_R_6);
  // sumw6+=fillHistos("../sPlot/NewsWeight_PT_1_3_Cen_20_30.root",D0Pt_6,JetPt_6,Z_6,R_6,ZPt_6,10,40,hArea_6,JetEta_6,D0Eta_6,JetPhi_6,D0Phi_6,D0JetEta_6,Eta_6,JetPt_R_6);
  // sumw6+=fillHistos("../sPlot/NewsWeight_PT_3_10_Cen_20_30.root",D0Pt_6,JetPt_6,Z_6,R_6,ZPt_6,10,40,hArea_6,JetEta_6,D0Eta_6,JetPhi_6,D0Phi_6,D0JetEta_6,Eta_6,JetPt_R_6);
  // sumw6+=fillHistos("../sPlot/NewsWeight_PT_1_10_Cen_20_30.root",D0Pt_6,JetPt_6,Z_6,R_6,ZPt_6,10,40,hArea_6,JetEta_6,D0Eta_6,JetPhi_6,D0Phi_6,D0JetEta_6,Eta_6,JetPt_R_6);
  // sumw6+=fillHistos("../sPlot/NewsWeight_PT_1_3_Cen_30_40.root",D0Pt_6,JetPt_6,Z_6,R_6,ZPt_6,10,40,hArea_6,JetEta_6,D0Eta_6,JetPhi_6,D0Phi_6,D0JetEta_6,Eta_6,JetPt_R_6);
  // sumw6+=fillHistos("../sPlot/NewsWeight_PT_3_10_Cen_30_40.root",D0Pt_6,JetPt_6,Z_6,R_6,ZPt_6,10,40,hArea_6,JetEta_6,D0Eta_6,JetPhi_6,D0Phi_6,D0JetEta_6,Eta_6,JetPt_R_6);
  // sumw6+=fillHistos("../sPlot/NewsWeight_PT_1_10_Cen_30_40.root",D0Pt_6,JetPt_6,Z_6,R_6,ZPt_6,10,40,hArea_6,JetEta_6,D0Eta_6,JetPhi_6,D0Phi_6,D0JetEta_6,Eta_6,JetPt_R_6);
  
  // sumw7+=fillHistos("../sPlot/NewsWeight_PT_1_3_Cen_40_80.root",D0Pt_7,JetPt_7,Z_7,R_7,ZPt_7,40,60,hArea_7,JetEta_7,D0Eta_7,JetPhi_7,D0Phi_7,D0JetEta_7,Eta_7,JetPt_R_7);
  // sumw7+=fillHistos("../sPlot/NewsWeight_PT_3_10_Cen_40_80.root",D0Pt_7,JetPt_7,Z_7,R_7,ZPt_7,40,60,hArea_7,JetEta_7,D0Eta_7,JetPhi_7,D0Phi_7,D0JetEta_7,Eta_7,JetPt_R_7);
  sumw7+=fillHistos("../sPlot/NewsWeight_PT_1_10_Cen_40_80.root",D0Pt_7,JetPt_7,Z_7,R_7,ZPt_7,40,60,hArea_7,JetEta_7,D0Eta_7,JetPhi_7,D0Phi_7,D0JetEta_7,Eta_7,JetPt_R_7);
  ...
  if(save){
      ...
      cout << "Integral here " << D0Pt_6->Integral() << " " << sumw6 << endl;
      cout << "Integral here " << D0Pt_5->Integral() << " " << sumw7 << endl;
      D0Pt_1->Write("D0Pt_0_10");
      D0Pt_2->Write("D0Pt_10_20");
      D0Pt_3->Write("D0Pt_20_30");
      D0Pt_4->Write("D0Pt_30_40"); 
      D0Pt_5->Write("D0Pt_40_80");
      D0Pt_6->Write("D0Pt_10_40");
      D0JPt_5->Write("D0JPt_40_80");
      JetPt->Write("JetPt");
      JetPt_1->Write("JetPt_0_10");
      JetPt_2->Write("JetPt_10_20");
      JetPt_3->Write("JetPt_20_30");
      JetPt_4->Write("JetPt_30_40");
      JetPt_5->Write("JetPt_40_80");
      JetPt_6->Write("JetPt_10_40");
      Z->Write("Z");
      Z_1->Write("Z_0_10");
      Z_2->Write("Z_10_20");
      Z_3->Write("Z_20_30");
...
void doSys(){
    ...
    for(int i = 0;i<166;i++){
      ...
      shuffleEff();
      applyWeightsNewBinningOldCuts(1);
    }
