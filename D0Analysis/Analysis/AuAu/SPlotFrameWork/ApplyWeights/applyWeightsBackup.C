...
bool useConst = true; // (D0-Jet) Pt <0 thronw away if true
bool useZ = false;// Cut events with D0 z <0 or > 1
bool SYS = false; //Run systematic uncertainties
char NAME[100] = "Histograms3_D05_10GeV_Const_JetPt0_20_With2DJetPtZ.root";
int SAVE = 1;
...
void applyWeightsBackup(int save = SAVE){
  ...
  TH1F *JetPt_8 = new TH1F("JetPt_8","JetPt_8",nbins_jpt,binning_jpt);
  TH1F *Z_8 = new TH1F("Z_8","Z_8",nbins_z,binning_z);
  TH1F *R_8 = new TH1F("R_8","R_8",nBinsdR,dRBins);
  TH2F *ZPt_8 = new TH2F("ZPt_8","ZPt_8",nbins_jpt,binning_jpt,nbins_z,binning_z);  
  TH2F *JetPt_R_8 = new TH2F("JetPt_R_8","JetPt_R_8",nBinsJetPt_R,JetPtBins_R,nBinsdR,dRBins);
  ...
  sumw8+=fillHistos("../sPlot/sWeight_PT_1_10_Cen_20_60.root",D0Pt_8,JetPt_8,Z_8,R_8,ZPt_8,20,60,hArea_8,JetEta_8,D0Eta_8,JetPhi_8,D0Phi_8,D0JetEta_8,Eta_8,JetPt_R_8);
