...
// found on file: ../Run14_SL16d_Embedding_PionPlus_Oct17.McAna.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../Run14_SL16d_Embedding_PionPlus_Oct17.McAna.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../Run14_SL16d_Embedding_PionPlus_Oct17.McAna.root");
      }
