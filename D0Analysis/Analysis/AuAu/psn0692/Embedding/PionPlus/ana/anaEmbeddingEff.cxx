...
int main(int argc, char **argv)
{
   ...
   TFile* fOut = new TFile("Eff_PionPlus_embedding.root", "recreate");
   ...
   for (int ic = 0; ic < nCent; ic++)
   {
      ...
      pTResRc[ic] = new TH2D(Form("pTResRc_%d", ic), Form("cent_%s;McpT;(RcpT - McpT)/ McpT", cent[ic]), 120, 0, 12, 1000, -1, 1);
   }
   ...
   gStyle->SetOptStat(1);
   TPDFManager* pdf = new TPDFManager("AuAu200GeV.PionPlus.Embedding.Efficiency");
