...
void plot_Rcp2()
{
   ...
   legend1 = new TLegend(0.78, 0.35, 0.93, 0.85);
   ...
   legend2 = new TLegend(0.85, 0.43, 0.93, 0.45);
   ...
   c1->SaveAs("D0_Rcp2.eps");
   c1->SaveAs("D0_Rcp2.pdf");
   c1->SaveAs("D0_Rcp2.gif");
   c1->SaveAs("D0_Rcp2.png");
}
