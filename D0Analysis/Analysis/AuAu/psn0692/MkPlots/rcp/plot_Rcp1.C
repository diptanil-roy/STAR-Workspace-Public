...
void plot_Rcp1()
{
   ...
   legend1 = new TLegend(0.78, 0.40, 0.93, 0.85);
   // legend1 = new TLegend(0.78, 0.28, 0.93, 0.83);
   ...
   legend1->AddEntry(cal_grPhi1[0], "#phi, ","p");
   // legend1->AddEntry(gD0err_xl[0], "D^{0} ", "p");
   // legend1->AddEntry(cal_grPhi1[0], "#phi, 0-10%", "p");
   // legend1->AddEntry(grp1, "p, 0-12%", "p");
   // legend1->AddEntry(gD0err_xl[0], "D^{0}, 0-10%", "p");
   legend1->Draw("same");

   // legend2 = new TLegend(0.86, 0.68, 0.95, 0.85);
   legend2 = new TLegend(0.85, 0.46, 0.93, 0.47);
   legend2->SetFillStyle(0);
   legend2->SetFillColor(10);
   legend2->SetBorderSize(0);
   legend2->SetTextSize(0.075);
   legend2->SetTextFont(42);
   // legend2->AddEntry(cal_grPhi1[0], " #phi","p");
   legend2->AddEntry(gD0err_xl[0], " D^{0} ", "p");
   legend2->Draw("same");
   ...
   for (int icent = 0; icent < ncent - 1; icent++)
   {
      ...
      // drawLatex(0.85, 0.25, buf, 42, 0.075, 1);
   TLatex *tex = new TLatex(7., 0.3, Form("(a)  %s%", nameCent[icent]));
   tex->SetTextFont(42);
   ...
   TLatex *tex = new TLatex(7., 0.3, Form("(b)  %s%", nameCent[icent]));
   tex->SetTextFont(42);
   ...
   for (int icent = 0; icent < ncent - 1; icent++)
   {
      ...
      // drawLatex(0.83, 0.38, buf, 42, 0.11, 1);
      //
   TLatex *tex = new TLatex(7., 0.3, Form("(c)  %s%", nameCent[icent]));
   tex->SetTextFont(42);
   tex->SetTextSize(0.11);
   // tex->SetNDC(kTRUE);
   tex->Draw("same");
   ...
   TLatex *tex = new TLatex(7., 0.3, Form("(d)  %s%", nameCent[icent]));
   tex->SetTextFont(42);
   ...
   c1->SaveAs("D0_Rcp1.eps");
   c1->SaveAs("D0_Rcp1.pdf");
   c1->SaveAs("D0_Rcp1.gif");
   c1->SaveAs("D0_Rcp1.png");
}
