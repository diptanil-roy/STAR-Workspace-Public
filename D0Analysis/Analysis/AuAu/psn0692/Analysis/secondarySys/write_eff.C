...
void write_eff() {
    ...
    TFile* fsimuD0 = new TFile("../D0_eff_combine_newPID_newCuts_extendpT_1108_181023NoSecondary.root"); //D0 Y// new PID // new Cuts
    // TFile* fsimuD0 = new TFile("../D0_eff_combine_newPID_newCuts_extendpT_Rebin_1113_ExtractDiff.root"); //D0 Y// new PID // new Cuts
    ...
    // TFile* fout = new TFile("data/eff_rebin.root","RECREATE");
    for(int icent=0; icent<ncent; icent++) {
