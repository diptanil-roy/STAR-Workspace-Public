...
void plot_effBinningCompHj()
{
    ...
    TH2F* h2Base_fs;
    TH2F* h2Eff_fs[neff];
    TFile* fin2 = new TFile("./out_old/effPureHijing.root");
    ...
    for(int icent=0; icent<ncent_vtx; icent++) {
        for(int ieff=0; ieff<neff; ieff++) {
            ...
            lg1->AddEntry(heffHj[icent][ieff],"New Hijing","p");
            lg1->AddEntry(heffFs[icent][ieff],"Old Hijing","p");
            lg1->Draw();
