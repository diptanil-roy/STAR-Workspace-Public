...
void plot_Rcp2_pTshift()
{
   ...
   TGraphErrors* gD0Rcp2_sys_vtx = (TGraphErrors*)fin2->Get(Form("gD0Rcp2_sys_vtx_40_60"));
   fin2->Close();
   ...
   for (int icent = 0; icent < ncent; icent++)
   {
      ...
      for (int ipt = 0; ipt < gD0err_xl[0]->GetN(); ipt++)
      {
         ...
         float base = gD0err_xl[ncent - 2]->GetY()[ipt] / NbinMean[ncent - 2]; //60-80%//40-60%
         float baseErr = gD0err_xl[ncent - 2]->GetEY()[ipt] / NbinMean[ncent - 2];
         float baseSys = gD0sys_xl[ncent - 2]->GetEY()[ipt] / NbinMean[ncent - 2];
         float Rcp = y / base;
      ...
      for (int ipt = 0; ipt < gD0err_xl[0]->GetN(); ipt++)
      {
         gD0Rcp1_sys_vtx->GetX()[ipt] = gD0err_xl[0]->GetX()[ipt] ;
         gD0Rcp2_sys_vtx->GetX()[ipt] = gD0err_xl[0]->GetX()[ipt] ;
      }
   ...
   gD0Rcp2_sys_vtx->Write("gD0Rcp2_sys_vtx_40_60");
}
