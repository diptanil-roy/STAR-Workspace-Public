...
root -l -b -q "CreateOldRespMacroMCOnlyFromCombinedFile.C(1, $2, \"$1$2\", 1)"
root -l -b -q "CreateOldRespMacroMCOnlyFromCombinedFile.C(1, $2, \"$1$2\", 2)"
root -l -b -q "UnfoldSimOldWayMacro.C(1, $2, \"$1$2\", \"true\")"

root -l -b -q "CreateOldRespMacroMCOnlyFromCombinedFile.C(1, $2, \"$1$2\")"
root -l -b -q "UnfoldDataOldWayMacro.C(1, $2, \"$1$2\", \"true\")"
