...
void GetCentralityWeights(){
	TFile *f1 = new TFile("Jan26_FONLL_HI_CombinedFileWithoutCentralityFix4/OldResponse_Step_1_IterParam_4_njptbin_15_nzbin_10.root");
	// TFile *f1 = new TFile("Dec30_DataHIUnf_Updated_WithCentWeight4/OldResponse_Step_1_IterParam_4_njptbin_15_nzbin_10.root ");
	TFile *f2 = new TFile("../SPlotFrameWork/ApplyWeights/Histograms3_D05_10GeV_NewBinningOldCuts.root");
	...
	TFile *f = new TFile("Cent_Weight.root", "RECREATE");
	f->cd();
	Weight->Write();
	f->Close();
}