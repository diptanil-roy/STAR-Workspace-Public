...
void Method(int SUPERITERATION = 0, int iteration = 3, TString DirName = "DataMCUnf", bool oldResponse = kFALSE, TString ResponseAppend = "Resp1D"){
	...
	TString FoldedFileName = Form("../SPlot_Mar2_2023/Histograms3_D05_10GeV_NewBinningOldCuts.root"); // Step 0 is always where I store the folded distro to be unfolded
