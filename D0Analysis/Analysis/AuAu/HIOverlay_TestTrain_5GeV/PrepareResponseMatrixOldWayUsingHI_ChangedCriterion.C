...
void PrepareResponseMatrixOldWayUsingHI_ChangedCriterion(int SUPERITERATION = 0, int iteration = 3, TString DirName = "MCMCUnf", bool makeInitialDistributionDifferent = kFALSE, int mode = 0){
