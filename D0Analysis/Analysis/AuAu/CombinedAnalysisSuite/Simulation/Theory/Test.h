...
// Mon Aug 28 13:14:15 2023 by ROOT version 6.28/04
// from TTree genevents/TTree containing event generator information
// found on file: pythia8_theory_comparison.starsim.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxmParticles = 517;
...
//    if (tree == 0) {
//       TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("pythia8_theory_comparison.starsim.root");
//       if (!f || !f->IsOpen()) {
//          f = new TFile("pythia8_theory_comparison.starsim.root");
//       }
...
Test::Test() : fChain(0)
{
   ...
   chain->Add("/Volumes/KWorkDrive/PYTHIA_D0_Theory/*.root");
   Init(chain);
}
