...
void Method(TString DirName = "MCMCUnf", int D0pTLow = 1, int SUPERITERATION = 1, int iteration = 4, bool simpleunfolding = kFALSE){
	...
	TFile *DataFile = new TFile(Form("../SPlotUpdated/AreaBased_JetPt_0_30/Histograms3_D0%i_10GeV_RecoJetPt_%i_%i_NewBinningOldCuts.root", D0pTLow, 0, (int)nbinsjetpt[njpt_bins] ), "READ");
	DataFile->cd();
