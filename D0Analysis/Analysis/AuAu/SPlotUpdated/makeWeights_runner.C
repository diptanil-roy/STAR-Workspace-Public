...
void makeWeights_runner(){
    RooMsgService::instance().setGlobalKillBelow(RooFit::ERROR);
    //Get Signal reduced tree
    TFile *f_D = new TFile("./out_final_AreaBased_May2.root");
...
void MakePlots(RooWorkspace* ws){
    ...
    sprintf(save,"plots_CS_D0JetpT_0_50/D0_Mass_sPlot_PT_%1.f_%1.f_Cen_%i_%i.pdf",_pt_low,_pt_high,_cen_low,_cen_high);
    cdata->SaveAs(save);
