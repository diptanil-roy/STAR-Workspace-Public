...
sed -i'.bak' 's/sWeights/sWeights_CS_JetpT_0_50/g' applyWeightsFor1GeV_runner.C
...
do
	...
	cp applyWeightsFor1GeV.C applyWeightsFor1GeV_runner.C
	sed -i'.bak' 's/applyWeightsFor1GeV/applyWeightsFor1GeV_runner/g' applyWeightsFor1GeV_runner.C
	sed -i'.bak' 's/sWeights/sWeights_FullRange/g' applyWeightsFor1GeV_runner.C
...
mkdir -p AreaBased_FullRange
mv Histograms* AreaBased_FullRange/.

rm applyWeightsFor1GeV_runner.C
rm applyWeightsFor1GeV_runner.C.bak