...
root -l -b -q "CreateResponseMatrixWithDataZ.C(\"$1$3\", $D0pTLow, 0, $3, 0)" #This step unfolds the measured histograms after the weighing process.
root -l -b -q "UnfoldData.C(\"$1$3\", $D0pTLow, 0, $3)"
root -l -b -q "CreateResponseMatrixWithDataZ.C(\"$1$3\", $D0pTLow, 1, $3, 0)" #This step unfolds the measured histograms after the weighing process.
