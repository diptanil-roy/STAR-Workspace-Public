...
class StarGenerator : public StMaker
{
 ...
 public:
  ...
  void SetFrame( const Char_t *frame);
  ...
  {static const char cvs[]="Tag $Name: SL21b $ $Id: StarGenerator.h,v 1.6 2015/04/24 18:21:11 jwebb Exp $ built " __DATE__ " " __TIME__ ; return cvs;}
