...
Bool_t StTagD0MCEvents::IsAnAcceptableTrack(StPicoTrack *trk, bool dohistograms = kFALSE){
...
Int_t StTagD0MCEvents::TopologicalCuts(StPicoTrack *trk1, StPicoTrack *trk2, bool dohistograms = kFALSE){
...
void StTagD0MCEvents::IsWhatParticle(StPicoTrack *trk, int &pid, double &m, double &e){ // NEW PID APPROACH
...
Int_t StTagD0MCEvents::IsWhatParticle(StPicoTrack *trk){ // Just to get the PID out
  int pid;
  double m; 
  double e;
...
Bool_t StTagD0MCEvents::KeepTrack(int trackid)
{
  ...
  int particleid = IsWhatParticle(trk);
