...
ClassImp(StHFAnalysis)

//________________________________________________________________________
StHFAnalysis::StHFAnalysis(const char* name, StPicoDstMaker *picoMaker, const char* outName = "", const char* jetMakerName = "", const char* rhoMakerName = "") : StJetFrameworkPicoBase(name) //StMaker(name),
{
  ...
  fDebugLevel = 0;
  fRunFlag = 0;       // see StHFAnalysis::fRunFlagEnum
  doppAnalysis = kFALSE;
...
//________________________________________________________________________
Int_t StHFAnalysis::Finish() { 
  cout << "StHFAnalysis::Finish()\n";
  ...
  cout<<"End of StHFAnalysis::Finish"<<endl;
...
//________________________________________________________________________
void StHFAnalysis::DeclareHistograms() {
...
void StHFAnalysis::WriteHistograms() {
...
//_____________________________________________________________________________
void StHFAnalysis::Clear(Option_t *opt) {
  fJets->Clear();
}
//
//  Function: This method is called every event.
//_____________________________________________________________________________
Int_t StHFAnalysis::Make() {
...
//________________________________________________________________________
Double_t StHFAnalysis::RelativePhi(Double_t mphi,Double_t vphi) const
...
Double_t StHFAnalysis::RelativeEPJET(Double_t jetAng, Double_t EPAng) const
{
...
//
//_________________________________________________________________________
void StHFAnalysis::FillEmcTriggers() {
...
//________________________________________________________________________
Bool_t StHFAnalysis::DoComparison(int myarr[], int elems) {
