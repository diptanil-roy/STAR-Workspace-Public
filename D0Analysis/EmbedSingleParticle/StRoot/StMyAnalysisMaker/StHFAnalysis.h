#ifndef StHFAnalysis_h
#define StHFAnalysis_h
...
class StHFAnalysis : public StJetFrameworkPicoBase {
  public:

    StHFAnalysis(const char *name, StPicoDstMaker *picoMaker, const char *outName, const char *jetMakerName, const char *rhoMakerName);
    virtual ~StHFAnalysis();
