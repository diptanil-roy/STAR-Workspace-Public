...
void Pythia8( TString config="pp:W", Double_t ckin3=0.0, Double_t ckin4=-1.0 )
{
  ...
  if ( config=="pp:heavyflavor:D0jets" ) 
    ...
    if ( config=="pp:heavyflavor:KStarjets" ) 
    {
      // pythia8->Set("HardQCD:gg2ccbar = on");
      // pythia8->Set("HardQCD:qqbar2ccbar = on");
      // pythia8->Set("Charmonium:all = on");
...
void starsimKStar( Int_t nevents=10, Int_t runnumber=15117062, TString runfile_="15117062.dat", int sequence=0, int dummy = 0, double ckin3 = 0.0, double ckin4 = 3.0 )
{ 
...
//   }
  ...
  Pythia8("pp:heavyflavor:KStarjets", ckin3, ckin4 );
  ...
  decayPy8->Set("313:onMode = 0");
  decayPy8->Set("313:onIfMatch = 321 -211");
  decayPy8->Set("313:onIfMatch = -321 211");
