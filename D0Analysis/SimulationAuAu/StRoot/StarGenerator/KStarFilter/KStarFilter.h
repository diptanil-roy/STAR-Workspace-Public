#ifndef __KStarFilter_h__
#define __KStarFilter_h__
...
class KStarFilter : public StarFilterMaker
{
public:
  KStarFilter( const char* name = "partfilt" );
  virtual ~KStarFilter(){ /* nada */ }
