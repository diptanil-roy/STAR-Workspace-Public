#ifndef __JetFilter_h__
#define __JetFilter_h__
...
class JetFilter : public StarFilterMaker
{
public:
  JetFilter( const char* name = "partfilt", double _zmin = 0., double _zmax = 1. );
  virtual ~JetFilter(){ /* nada */ }
