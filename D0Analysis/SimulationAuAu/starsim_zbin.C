...
void starsim_zbin( Int_t nevents=1, Int_t runnumber=15117062, TString runfile_="15117062.dat", int sequence=0, int dummy = 0, double ckin3 = 3.0, double ckin4 = 0.0, double zlow = 0.7, double zhigh = 0.8 )
{ 
...
//   }
  ...
  filter = new JetFilter("partfilt", zlow, zhigh);
