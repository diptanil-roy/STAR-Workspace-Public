...
void starsim( Int_t nevents=10, Int_t runnumber=13039122, TString runfile_="13039122", int sequence=0, int dummy = 0 )
{ 
  ...
  {
    TString simple = "y2012a geant gstar usexgeom agml DbV20130212 ";
    bfc(0, simple );
  }
...
//   }
  ...
  cout << "============================================" << endl;
  cout << runnumber-13039121 << "\t" << event << endl;
