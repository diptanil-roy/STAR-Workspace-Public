#ifndef StInvariantMass_h
#define StInvariantMass_h
...
class StInvariantMass : public StJetFrameworkPicoBase {
  public:

    bool testrun = kTRUE;

    StInvariantMass(const char *name, StPicoDstMaker *picoMaker, const char *outName, const char* jetMakerName, const char *rhoMakerName);
    virtual ~StInvariantMass();
