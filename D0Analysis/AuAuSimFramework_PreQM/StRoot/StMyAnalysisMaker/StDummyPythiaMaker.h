#ifndef StDummyPythiaMaker_h
#define StDummyPythiaMaker_h
...
class StDummyPythiaMaker : public StJetFrameworkPicoBase {
  public:

    StDummyPythiaMaker(const char *name, StPicoDstMaker *picoMaker, const char *outName, const char *jetMakerName, const char *rhoMakerName);
    virtual ~StDummyPythiaMaker();
