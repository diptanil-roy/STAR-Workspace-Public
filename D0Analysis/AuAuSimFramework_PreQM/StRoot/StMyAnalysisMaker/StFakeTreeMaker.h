#ifndef StFakeTreeMaker_h
#define StFakeTreeMaker_h

#include "StJetFrameworkPicoBase.h"
#include "StFakeJetTree.h"
#include <vector>
...
class StTagD0Events;
class StThrowARandomTrack;
class StD0EventsJetMaker;
class StD0Rho;

class StFakeTreeMaker : public StJetFrameworkPicoBase {
  public:

    StFakeTreeMaker(const char *name, StPicoDstMaker *picoMaker, const char *outName, const char *jetMakerName, const char *rhoMakerName);
    virtual ~StFakeTreeMaker();
  ...
  private:
    ...
    // Random Track objects
    StThrowARandomTrack   *mRandomTrack;            // Random Track object
