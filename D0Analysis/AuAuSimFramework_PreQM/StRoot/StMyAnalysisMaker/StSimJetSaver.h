#ifndef StSimJetSaver_h
#define StSimJetSaver_h
...
class StSimJetSaver : public StJetFrameworkPicoBase {
  public:

    StSimJetSaver(const char *name, StPicoDstMaker *picoMaker, const char *outName, const char *mcjetMakerName, const char* recojetMakerName, const char *d0taggername, const char *rhoMakerName);
    virtual ~StSimJetSaver();
