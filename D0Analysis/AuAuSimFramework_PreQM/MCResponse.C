...
//        Int_t nEvents = 1000000;
	...
	//StPicoDstMaker *picoMaker = new StPicoDstMaker(0,inputFile,"picoDst");
        ...
        StSimJetSaver         *SimJetSaverSmear[3];

        for (int centbin = 2; centbin < 3; centbin++){
          ...
          jetTaskMCSmear[centbin]->SetMinJetPt(5.0);             // 15.0 signal jets
          ...
          jetTaskRecoSmear[centbin] = new StSimD0EventsJetMaker(Form("JetMakerRecoSmear_%s", binname[centbin].Data()), fJetConstituentCut, D0MCTaggerSmear[centbin]->GetName(), kTRUE, outputFile);
          ...
          SimJetSaverSmear[centbin] = new StSimJetSaver(Form("SimJetSaverSmear_%s", binname[centbin].Data()), picoMaker, jets.Data(), jetTaskMCSmear[centbin]->GetName(), jetTaskRecoSmear[centbin]->GetName(), D0MCTaggerSmear[centbin]->GetName(), "");
