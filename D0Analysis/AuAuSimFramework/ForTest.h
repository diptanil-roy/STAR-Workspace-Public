...
// Mon May 23 17:21:14 2022 by ROOT version 6.20/08
// from TTree PicoDst/StPicoDst
// found on file: rcf22000_15165046_0009_1_1000evts.picoDst.root
//////////////////////////////////////////////////////////
...
#ifdef ForTest_cxx
ForTest::ForTest(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("rcf22000_15165046_0009_1_1000evts.picoDst.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("rcf22000_15165046_0009_1_1000evts.picoDst.root");
      }
...
Int_t ForTest::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ForTest::LoadTree(Long64_t entry)
{
...
void ForTest::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Track.mTopologyMap[2]", Track_mTopologyMap, &b_Track_mTopologyMap);
   ...
   fChain->SetBranchAddress("Track.mTopoMap_iTpc", Track_mTopoMap_iTpc, &b_Track_mTopoMap_iTpc);
   ...
   fChain->SetBranchAddress("McTrack.mHits[22]", McTrack_mHits, &b_McTrack_mHits);
...
void ForTest::Show(Long64_t entry)
{
...
Int_t ForTest::Cut(Long64_t entry)
{
