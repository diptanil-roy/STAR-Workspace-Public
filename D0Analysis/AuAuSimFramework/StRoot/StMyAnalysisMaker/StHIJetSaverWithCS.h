#ifndef StHIJetSaverWithCS_h
#define StHIJetSaverWithCS_h
...
class StHIJetSaverWithCS : public StJetFrameworkPicoBase {
  public:

    StHIJetSaverWithCS(const char *name, StPicoDstMaker *picoMaker, const char *outName1, const char *outName2);
    virtual ~StHIJetSaverWithCS();
  ...
  private:
    ...
    std::vector<TClonesArray *> fJetsArrRecoCS;

    TH1F *hDiffJetPt;

    ClassDef(StHIJetSaverWithCS, 1)
};
#endif
