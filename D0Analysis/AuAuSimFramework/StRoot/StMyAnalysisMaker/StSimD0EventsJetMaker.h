#ifndef STSIMD0EVENTSJETMAKER_H
#define STSIMD0EVENTSJETMAKER_H
...
class StSimD0EventsJetMaker : public StMaker {
 public:
  ...
  StSimD0EventsJetMaker();
  StSimD0EventsJetMaker(const char *name, double mintrackPt, const char *d0taggername, const char *mcjetmakername, bool dohistos, const char* outName);
  virtual ~StSimD0EventsJetMaker();
...
//  Bool_t                 mTowerStatusArr[4800];
  ...
  StSimD0EventsJetMaker(const StSimD0EventsJetMaker&);            // not implemented
  StSimD0EventsJetMaker &operator=(const StSimD0EventsJetMaker&); // not implemented

  ClassDef(StSimD0EventsJetMaker, 4) // Jet producing task
};
#endif
