#ifndef StSimJetSaver_Test_h
#define StSimJetSaver_Test_h
...
class StSimJetSaver_Test : public StJetFrameworkPicoBase {
  public:

    StSimJetSaver_Test(const char *name, StPicoDstMaker *picoMaker, const char *outName, const char *mcjetMakerName, const char* recojetMakerName, const char *d0taggername, const char *rhoMakerName);
    virtual ~StSimJetSaver_Test();
