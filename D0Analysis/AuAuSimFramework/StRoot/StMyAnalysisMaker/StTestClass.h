#ifndef StTestClass_h
#define StTestClass_h
...
class StTestClass : public StJetFrameworkPicoBase {
  public:

    StTestClass(const char *name, StPicoDstMaker *picoMaker, const char *outName);
    virtual ~StTestClass();
  ...
  private:
    ...
    TH1F *hCentralitySoft;
    TH1F *hCentrality;

    TH1F *hSoftEventMaxPt;
    TH1F *hMaxPt;
