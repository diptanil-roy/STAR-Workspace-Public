...
class StEmcPosition2 : public TObject
{
   public:            
    ...
    Bool_t            projTrack(TVector3* atFinal,TVector3* momentumAtFinal,const StPicoTrack* const track,TVector3 mVertex,Double_t magField,Double_t radius=225.405,Int_t option=1) const;    ///< Track projection utility
    Bool_t            projTrack(TVector3* atFinal,TVector3* momentumAtFinal,TVector3 gMom,TVector3 mVertex,Double_t magField,int charge,Double_t radius=225.405,Int_t option=1) const;    ///< Track projection utility
