...
void MCResponse_Test(const Char_t *inputFile="Run12.list", const Char_t *outputFile="ResponseMatrices.root", Int_t nEv = 1, const Char_t *fOutJobappend="")
{
//        Int_t nEvents = 10000;
        Int_t nEvents = 1;
//        Int_t nEvents = 1000000;
      if(nEv > 100) nEvents = 100000000;
        ...
        if((RunYear == mRun14) && doTEST) {
          ...
          inputFile = "/gpfs01/star/pwg/droy1/STAR-Workspace/D0Analysis/AuAuSimFramework/MCTestFile_ZBin3.list";
        }
	...
	//StPicoDstMaker *picoMaker = new StPicoDstMaker(0,inputFile,"picoDst");
        ...
        StTagD0MCEvents       *D0MCTaggerSmear[1];
        StMCD0JetMaker        *jetTaskMCSmear[2];
        ...
        for (int centbin = 0; centbin < 1; centbin++){
          ...
          jetTaskMCSmear[centbin]->SetMinJetPt(0.2);             // 15.0 signal jets
