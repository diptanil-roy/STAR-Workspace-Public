...
void MCResponseMakerLocal(const Char_t *inputFile="Run12.list", const Char_t *outputFile="ResponseMatrices.root", Int_t nEv = 1, const Char_t *fOutJobappend="")
{
//        Int_t nEvents = 10000;
        Int_t nEvents = 100;
//        Int_t nEvents = 1000000;
      if(nEv > 100) nEvents = 100000000;
        ...
        if((RunYear == mRun14) && doTEST) {
            ...
            inputFile = "/gpfs01/star/pwg/droy1/TestCodeDirectory/OfficialSimulationFileList.list";
        }
