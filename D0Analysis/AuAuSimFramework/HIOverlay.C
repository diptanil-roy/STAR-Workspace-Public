...
void HIOverlay(const Char_t *inputFile="Run12.list", const char *mcfilename ="/gpfs01/star/pwg/droy1/STAR-Workspace/D0Analysis/AuAuSimFramework/TestFile.list", const Char_t *outputFile="ResponseMatrices", Int_t nEv = 1, const Char_t *fOutJobappend="")
{
//        Int_t nEvents = 10000;
        Int_t nEvents = 200;
//        Int_t nEvents = 1000000;
	...
	//StPicoDstMaker *picoMaker = new StPicoDstMaker(0,inputFile,"picoDst");
        ...
        HIMCJetMaker->SetMinJetPt(0.2);             // 15.0 signal jets
